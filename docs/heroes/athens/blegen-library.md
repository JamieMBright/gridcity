...
Wikidata: [Q58075070](https://www.wikidata.org/wiki/Q58075070)
Reference photo: (none on Wikidata)

## Description
library in Athens, Greece

## Recreation spec (instruction for the bespoke sprite)
Recreate **Blegen library** as a CUSTOM iso sprite in the game's ink-contour dusk
