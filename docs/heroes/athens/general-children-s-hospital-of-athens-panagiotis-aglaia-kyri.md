# General Children's Hospital of Athens "Panagiotis & Aglaia Kyriakou"
*hospital, medical organization · 1900*

Wikidata: [Q16327187](https://www.wikidata.org/wiki/Q16327187)
...
Recreate **General Children's Hospital of Athens "Panagiotis & Aglaia Kyriakou"** as a CUSTOM iso sprite in the game's ink-contour dusk
style — do not reuse another hero. Work from the reference photo above.
- **Type / style:** hospital, medical organization.
- **Footprint:** ~3×3 tiles (from its real OSM
  extent of 3.0 tiles). Draw it WIDE within that square.
