...
*cultural center, school · 1907*

Wikidata: [Q3152251](https://www.wikidata.org/wiki/Q3152251)
Reference photo: (none on Wikidata)

## Description
organization for cultural action and cooperation

## Recreation spec (instruction for the bespoke sprite)
Recreate **Institut français de Grèce** as a CUSTOM iso sprite in the game's ink-contour dusk
style — do not reuse another hero. Work from the reference photo above.
- **Type / style:** cultural center, school.
- **Footprint:** ~2×2 tiles (from its real OSM
  extent of 1.9 tiles). Draw it WIDE within that square.
