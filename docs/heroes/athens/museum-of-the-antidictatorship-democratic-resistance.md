...
Wikidata: [Q112332552](https://www.wikidata.org/wiki/Q112332552)
Reference photo: (none on Wikidata)

## Description
museum in Parko Eleftherias, Athens, Greece

## Recreation spec (instruction for the bespoke sprite)
Recreate **Museum of the Antidictatorship Democratic Resistance** as a CUSTOM iso sprite in the game's ink-contour dusk
