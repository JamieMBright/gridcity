...
Wikidata: [Q30280336](https://www.wikidata.org/wiki/Q30280336)
Reference photo: (none on Wikidata)

## Description
healthcare organization in Athens, Greece

## Recreation spec (instruction for the bespoke sprite)
Recreate **Polyclinic General Hospital** as a CUSTOM iso sprite in the game's ink-contour dusk
style — do not reuse another hero. Work from the reference photo above.
- **Type / style:** medical organization, hospital.
