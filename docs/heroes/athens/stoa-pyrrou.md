# Stoa Pyrrou
*commercial building, protected building in Greece · 1885*

Wikidata: [Q38284513](https://www.wikidata.org/wiki/Q38284513)
Reference photo: (none on Wikidata)

## Description
protected commercial building in Athens

## Recreation spec (instruction for the bespoke sprite)
Recreate **Stoa Pyrrou** as a CUSTOM iso sprite in the game's ink-contour dusk
style — do not reuse another hero. Work from the reference photo above.
- **Type / style:** commercial building, protected building in Greece.
- **Footprint:** ~1×1 tiles (from its real OSM
  extent of 1.2 tiles). Draw it WIDE within that square.
