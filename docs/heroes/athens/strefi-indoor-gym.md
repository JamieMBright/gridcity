...
Wikidata: [Q108516680](https://www.wikidata.org/wiki/Q108516680)
Reference photo: (none on Wikidata)

## Description
basketball venue at Athens, Greece

## Recreation spec (instruction for the bespoke sprite)
Recreate **Strefi Indoor Gym** as a CUSTOM iso sprite in the game's ink-contour dusk
