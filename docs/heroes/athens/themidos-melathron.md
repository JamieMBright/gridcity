# Themidos Melathron
*courthouse · Iasonas Rizos, Dimitris Kataropoulos · 1981*

Wikidata: [Q50991558](https://www.wikidata.org/wiki/Q50991558)
Reference photo: https://commons.wikimedia.org/wiki/Special:FilePath/Filakesaverof.jpg?width=1000

## Description
courthouse in Athens, Greece

## Recreation spec (instruction for the bespoke sprite)
Recreate **Themidos Melathron** as a CUSTOM iso sprite in the game's ink-contour dusk
...
- **Footprint:** ~3×3 tiles (from its real OSM
  extent of 3.3 tiles). Draw it WIDE within that square.
