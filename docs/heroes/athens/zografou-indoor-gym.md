# Zografou Indoor Gym
*sports venue, basketball court*

Wikidata: [Q111109362](https://www.wikidata.org/wiki/Q111109362)
Reference photo: (none on Wikidata)

## Description
basketball venue at Zografou, Attica, Greece

## Recreation spec (instruction for the bespoke sprite)
Recreate **Zografou Indoor Gym** as a CUSTOM iso sprite in the game's ink-contour dusk
style — do not reuse another hero. Work from the reference photo above.
- **Type / style:** sports venue, basketball court.
