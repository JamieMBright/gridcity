...
Wikidata: [Q1357181](https://www.wikidata.org/wiki/Q1357181)
Reference photo: https://commons.wikimedia.org/wiki/Special:FilePath/Berlin%20Ernst-Reuter-Haus%20001.JPG?width=1000

## Description
architectural structure

## Recreation spec (instruction for the bespoke sprite)
Recreate **Ernst-Reuter-Haus** as a CUSTOM iso sprite in the game's ink-contour dusk
...
- **Footprint:** ~5×5 tiles (from its real OSM
  extent of 6.0 tiles). Draw it WIDE within that square.
