...
Wikidata: [Q17591274](https://www.wikidata.org/wiki/Q17591274)
Reference photo: https://commons.wikimedia.org/wiki/Special:FilePath/Berlin%20-%20Quartier%20205.jpg?width=1000

## Description
department store in Berlin, Germany

## Recreation spec (instruction for the bespoke sprite)
Recreate **Quartier 205** as a CUSTOM iso sprite in the game's ink-contour dusk
style — do not reuse another hero. Work from the reference photo above.
- **Type / style:** department store.
