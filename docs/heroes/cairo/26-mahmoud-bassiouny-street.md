...
*building · Art Deco architecture*

Wikidata: [Q110011560](https://www.wikidata.org/wiki/Q110011560)
Reference photo: (none on Wikidata)

## Description
Art Deco building in Downtown Cairo

## Recreation spec (instruction for the bespoke sprite)
Recreate **26 Mahmoud Bassiouny Street** as a CUSTOM iso sprite in the game's ink-contour dusk
style — do not reuse another hero. Work from the reference photo above.
- **Type / style:** building, Art Deco architecture.
