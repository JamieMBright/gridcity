...
Wikidata: [Q110822400](https://www.wikidata.org/wiki/Q110822400)
Reference photo: (none on Wikidata)

## Description
mission diplomatique colombienne

## Recreation spec (instruction for the bespoke sprite)
Recreate **embassy of Colombia in Egypt** as a CUSTOM iso sprite in the game's ink-contour dusk
