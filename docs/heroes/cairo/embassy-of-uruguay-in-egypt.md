...
Wikidata: [Q110616199](https://www.wikidata.org/wiki/Q110616199)
Reference photo: (none on Wikidata)

## Description
mission diplomatique uruguayenne

## Recreation spec (instruction for the bespoke sprite)
Recreate **embassy of Uruguay in Egypt** as a CUSTOM iso sprite in the game's ink-contour dusk
