# Kasr Kamal al-Din
*palace · baroque revival, Renaissance Revival architecture · Antonio Lasciac · 1906*

Wikidata: [Q126916725](https://www.wikidata.org/wiki/Q126916725)
Reference photo: https://commons.wikimedia.org/wiki/Special:FilePath/CairoDubaraKamalDin.jpg?width=1000

## Description


## Recreation spec (instruction for the bespoke sprite)
Recreate **Kasr Kamal al-Din** as a CUSTOM iso sprite in the game's ink-contour dusk
style — do not reuse another hero. Work from the reference photo above.
- **Type / style:** palace, baroque revival, Renaissance Revival architecture.
- **Footprint:** ~2×2 tiles (from its real OSM
  extent of 1.8 tiles). Draw it WIDE within that square.
