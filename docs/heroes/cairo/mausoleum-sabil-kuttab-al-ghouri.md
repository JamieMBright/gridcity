# Mausoleum-Sabil-Kuttab Al-Ghouri
*building · Mamluk architecture · 1505*

Wikidata: [Q126914593](https://www.wikidata.org/wiki/Q126914593)
...
Recreate **Mausoleum-Sabil-Kuttab Al-Ghouri** as a CUSTOM iso sprite in the game's ink-contour dusk
style — do not reuse another hero. Work from the reference photo above.
- **Type / style:** building, Mamluk architecture.
