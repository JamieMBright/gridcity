...
Wikidata: [Q47429618](https://www.wikidata.org/wiki/Q47429618)
Reference photo: https://commons.wikimedia.org/wiki/Special:FilePath/CairoSteigenbergerHotelElTahrir.jpg?width=1000

## Description
hotel in Cairo

## Recreation spec (instruction for the bespoke sprite)
Recreate **Steigenberger Hotel El Tahrir Cairo** as a CUSTOM iso sprite in the game's ink-contour dusk
style — do not reuse another hero. Work from the reference photo above.
- **Type / style:** hotel.
- **Footprint:** ~3×3 tiles (from its real OSM
  extent of 2.9 tiles). Draw it WIDE within that square.
