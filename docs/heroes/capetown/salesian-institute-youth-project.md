...
Wikidata: [Q137478466](https://www.wikidata.org/wiki/Q137478466)
...
Recreate **Salesian Institute Youth Project** as a CUSTOM iso sprite in the game's ink-contour dusk
style — do not reuse another hero. Work from the reference photo above.
- **Type / style:** youth center.
