...
Wikidata: [Q10924181](https://www.wikidata.org/wiki/Q10924181)
Reference photo: https://commons.wikimedia.org/wiki/Special:FilePath/Caroline%20Centre.JPG?width=1000

## Description
office building and shopping mall in Hong Kong

## Recreation spec (instruction for the bespoke sprite)
Recreate **Lee Garden Two** as a CUSTOM iso sprite in the game's ink-contour dusk
style — do not reuse another hero. Work from the reference photo above.
- **Type / style:** office building, shopping center.
- **Footprint:** ~4×4 tiles (from its real OSM
  extent of 4.1 tiles). Draw it WIDE within that square.
