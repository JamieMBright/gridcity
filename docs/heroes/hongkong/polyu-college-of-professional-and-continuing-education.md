...
Wikidata: [Q105394784](https://www.wikidata.org/wiki/Q105394784)
Reference photo: (none on Wikidata)

## Description
university college located in Hong Kong

## Recreation spec (instruction for the bespoke sprite)
Recreate **PolyU College of Professional and Continuing Education** as a CUSTOM iso sprite in the game's ink-contour dusk
