...
Wikidata: [Q28417468](https://www.wikidata.org/wiki/Q28417468)
Reference photo: https://commons.wikimedia.org/wiki/Special:FilePath/Royal%20Garden%20Hotel%202011.jpg?width=1000

## Description
hotel in Hong Kong

## Recreation spec (instruction for the bespoke sprite)
Recreate **Royal Garden Hotel** as a CUSTOM iso sprite in the game's ink-contour dusk
style — do not reuse another hero. Work from the reference photo above.
- **Type / style:** hotel.
- **Footprint:** ~2×2 tiles (from its real OSM
  extent of 2.0 tiles). Draw it WIDE within that square.
