...
Wikidata: [Q10875308](https://www.wikidata.org/wiki/Q10875308)
Reference photo: (none on Wikidata)

## Description
sport centre inside of Sun Yat Sen Memorial Park, Hong Kong

## Recreation spec (instruction for the bespoke sprite)
Recreate **Sun Yat Sen Memorial Park Sports Centre** as a CUSTOM iso sprite in the game's ink-contour dusk
