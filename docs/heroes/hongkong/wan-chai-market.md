...
Wikidata: [Q7966987](https://www.wikidata.org/wiki/Q7966987)
Reference photo: https://commons.wikimedia.org/wiki/Special:FilePath/Wan%20Chai%20Market%20Outside%20View%202008.jpg?width=1000

## Description


## Recreation spec (instruction for the bespoke sprite)
Recreate **Wan Chai Market** as a CUSTOM iso sprite in the game's ink-contour dusk
style — do not reuse another hero. Work from the reference photo above.
- **Type / style:** fixed construction.
