# 2-54, Cranley Gardens Sw7
*building*

Wikidata: [Q27085371](https://www.wikidata.org/wiki/Q27085371)
Reference photo: (none on Wikidata)

## Description
building in Kensington and Chelsea, London, England, UK

## Recreation spec (instruction for the bespoke sprite)
Recreate **2-54, Cranley Gardens Sw7** as a CUSTOM iso sprite in the game's ink-contour dusk
