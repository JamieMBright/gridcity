...
*hotel · Edward Middleton Barry*

Wikidata: [Q111368954](https://www.wikidata.org/wiki/Q111368954)
Reference photo: (none on Wikidata)

## Description
5-star hotel in the City of London, United Kingdom

## Recreation spec (instruction for the bespoke sprite)
Recreate **Andaz London Liverpool Street, by Hyatt** as a CUSTOM iso sprite in the game's ink-contour dusk
