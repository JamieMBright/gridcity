...
Wikidata: [Q27083487](https://www.wikidata.org/wiki/Q27083487)
Reference photo: (none on Wikidata)

## Description
apartment building in Westminster, London, England, UK

## Recreation spec (instruction for the bespoke sprite)
Recreate **Chaucer House** as a CUSTOM iso sprite in the game's ink-contour dusk
