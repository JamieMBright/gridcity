...
Wikidata: [Q27084505](https://www.wikidata.org/wiki/Q27084505)
Reference photo: (none on Wikidata)

## Description
building in Camden, London, England, UK

## Recreation spec (instruction for the bespoke sprite)
Recreate **Eversholt House And Attached Railings** as a CUSTOM iso sprite in the game's ink-contour dusk
