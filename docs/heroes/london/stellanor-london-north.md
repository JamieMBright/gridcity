...
Wikidata: [Q138440597](https://www.wikidata.org/wiki/Q138440597)
Reference photo: (none on Wikidata)

## Description
data centre in Clerkenwell, London

## Recreation spec (instruction for the bespoke sprite)
Recreate **Stellanor London North** as a CUSTOM iso sprite in the game's ink-contour dusk
style — do not reuse another hero. Work from the reference photo above.
- **Type / style:** data center.
