...
Wikidata: [Q26525407](https://www.wikidata.org/wiki/Q26525407)
Reference photo: (none on Wikidata)

## Description
building in South Tyneside, Tyne and Wear, England, UK

## Recreation spec (instruction for the bespoke sprite)
Recreate **37-57, Beach Road** as a CUSTOM iso sprite in the game's ink-contour dusk
