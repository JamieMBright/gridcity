...
Wikidata: [Q26275934](https://www.wikidata.org/wiki/Q26275934)
Reference photo: (none on Wikidata)

## Description
building in Gateshead, Tyne and Wear, England, UK

## Recreation spec (instruction for the bespoke sprite)
Recreate **Co-Operative Buildings** as a CUSTOM iso sprite in the game's ink-contour dusk
