...
Wikidata: [Q26242212](https://www.wikidata.org/wiki/Q26242212)
Reference photo: (none on Wikidata)

## Description
hotel in Sunderland, United Kingdom

## Recreation spec (instruction for the bespoke sprite)
Recreate **Hilton Garden Inn Sunderland** as a CUSTOM iso sprite in the game's ink-contour dusk
