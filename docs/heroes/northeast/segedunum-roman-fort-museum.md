...
Wikidata: [Q68044879](https://www.wikidata.org/wiki/Q68044879)
Reference photo: (none on Wikidata)

## Description
museum in Wallsend, Tyne and Wear, England, UK

## Recreation spec (instruction for the bespoke sprite)
Recreate **Segedunum Roman Fort & Museum** as a CUSTOM iso sprite in the game's ink-contour dusk
style — do not reuse another hero. Work from the reference photo above.
- **Type / style:** museum, local authority museum.
