...
Wikidata: [Q17552409](https://www.wikidata.org/wiki/Q17552409)
Reference photo: https://commons.wikimedia.org/wiki/Special:FilePath/The%20Keelman%20Hospital%20-%20geograph.org.uk%20-%201415083.jpg?width=1000

## Description
hospital building in Newcastle upon Tyne, Tyne and Wear, England, UK

## Recreation spec (instruction for the bespoke sprite)
Recreate **The Keelmen's Hospital** as a CUSTOM iso sprite in the game's ink-contour dusk
style — do not reuse another hero. Work from the reference photo above.
- **Type / style:** hospital building.
- **Footprint:** ~1×1 tiles (from its real OSM
  extent of 0.4 tiles). Draw it WIDE within that square.
