...
Wikidata: [Q41560562](https://www.wikidata.org/wiki/Q41560562)
Reference photo: (none on Wikidata)

## Description
cinema in Cramlington, England

## Recreation spec (instruction for the bespoke sprite)
Recreate **Vue Cramlington** as a CUSTOM iso sprite in the game's ink-contour dusk
