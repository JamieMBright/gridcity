...
Wikidata: [Q2946122](https://www.wikidata.org/wiki/Q2946122)
Reference photo: https://commons.wikimedia.org/wiki/Special:FilePath/Paris%20-%20Maison%20de%20la%20RATP%2003.jpg?width=1000

## Description
ensemble des dépôts d'autobus de la RATP

## Recreation spec (instruction for the bespoke sprite)
Recreate **Centres bus RATP** as a CUSTOM iso sprite in the game's ink-contour dusk
style — do not reuse another hero. Work from the reference photo above.
- **Type / style:** facility.
- **Footprint:** ~5×5 tiles (from its real OSM
  extent of 5.4 tiles). Draw it WIDE within that square.
