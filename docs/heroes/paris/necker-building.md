# Necker Building
*ministry building · 1981*

Wikidata: [Q109523040](https://www.wikidata.org/wiki/Q109523040)
...
Recreate **Necker Building** as a CUSTOM iso sprite in the game's ink-contour dusk
style — do not reuse another hero. Work from the reference photo above.
- **Type / style:** ministry building.
- **Footprint:** ~5×5 tiles (from its real OSM
  extent of 10.9 tiles). Draw it WIDE within that square.
