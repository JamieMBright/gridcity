# Porte de Versailles exhibition centre hall 3
*exhibition park*

Wikidata: [Q128305135](https://www.wikidata.org/wiki/Q128305135)
Reference photo: (none on Wikidata)

## Description
hall du parc des expositions de la Porte de Versailles

## Recreation spec (instruction for the bespoke sprite)
Recreate **Porte de Versailles exhibition centre hall 3** as a CUSTOM iso sprite in the game's ink-contour dusk
style — do not reuse another hero. Work from the reference photo above.
- **Type / style:** exhibition park.
- **Footprint:** ~5×5 tiles (from its real OSM
  extent of 6.4 tiles). Draw it WIDE within that square.
