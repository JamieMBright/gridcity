# Porte de Versailles exhibition centre hall 4
*exhibition park*

Wikidata: [Q128305136](https://www.wikidata.org/wiki/Q128305136)
...
Recreate **Porte de Versailles exhibition centre hall 4** as a CUSTOM iso sprite in the game's ink-contour dusk
...
- **Footprint:** ~5×5 tiles (from its real OSM
  extent of 7.1 tiles). Draw it WIDE within that square.
