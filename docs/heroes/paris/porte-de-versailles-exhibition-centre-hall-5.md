# Porte de Versailles exhibition centre hall 5
*exhibition park*

Wikidata: [Q128305137](https://www.wikidata.org/wiki/Q128305137)
...
Recreate **Porte de Versailles exhibition centre hall 5** as a CUSTOM iso sprite in the game's ink-contour dusk
...
- **Footprint:** ~5×5 tiles (from its real OSM
  extent of 5.6 tiles). Draw it WIDE within that square.
