...
Wikidata: [Q98803738](https://www.wikidata.org/wiki/Q98803738)
Reference photo: https://commons.wikimedia.org/wiki/Special:FilePath/Building%20and%20tower%20of%20All%20India%20Radio%2C%20Pune.jpg?width=1000

## Description
public radio broadcaster in Pune, Maharashtra

## Recreation spec (instruction for the bespoke sprite)
Recreate **All India Radio, Pune** as a CUSTOM iso sprite in the game's ink-contour dusk
style — do not reuse another hero. Work from the reference photo above.
- **Type / style:** government agency.
