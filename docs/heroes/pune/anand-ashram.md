...
Wikidata: [Q98803739](https://www.wikidata.org/wiki/Q98803739)
Reference photo: https://commons.wikimedia.org/wiki/Special:FilePath/Anandashram%20Sanstha%2C%20Pune.jpg?width=1000

## Description
institution for preservation and promotion of Sanskrit in Pune, Maharashtra

## Recreation spec (instruction for the bespoke sprite)
Recreate **Anand Ashram** as a CUSTOM iso sprite in the game's ink-contour dusk
style — do not reuse another hero. Work from the reference photo above.
- **Type / style:** organization.
