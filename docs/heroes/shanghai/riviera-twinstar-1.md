...
Wikidata: [Q27940894](https://www.wikidata.org/wiki/Q27940894)
Reference photo: (none on Wikidata)

## Description
more westerly of the two Riviera TwinStar twin towers, Shanghai

## Recreation spec (instruction for the bespoke sprite)
Recreate **Riviera TwinStar 1** as a CUSTOM iso sprite in the game's ink-contour dusk
