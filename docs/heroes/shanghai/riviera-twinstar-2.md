...
Wikidata: [Q27940895](https://www.wikidata.org/wiki/Q27940895)
Reference photo: (none on Wikidata)

## Description
more easterly of the two Riviera TwinStar twin towers, Shanghai

## Recreation spec (instruction for the bespoke sprite)
Recreate **Riviera TwinStar 2** as a CUSTOM iso sprite in the game's ink-contour dusk
