...
Wikidata: [Q27921597](https://www.wikidata.org/wiki/Q27921597)
Reference photo: (none on Wikidata)

## Description
building in Shanghai,part of Shanghai International Finance Centre

## Recreation spec (instruction for the bespoke sprite)
Recreate **Shanghai IFC North Tower** as a CUSTOM iso sprite in the game's ink-contour dusk
