# tour sud du Shanghai IFC
*multi-story urban building · César Pelli*

Wikidata: [Q1648492](https://www.wikidata.org/wiki/Q1648492)
Reference photo: (none on Wikidata)

## Description
partie du complexe Shanghai IFC

## Recreation spec (instruction for the bespoke sprite)
Recreate **tour sud du Shanghai IFC** as a CUSTOM iso sprite in the game's ink-contour dusk
style — do not reuse another hero. Work from the reference photo above.
- **Type / style:** multi-story urban building.
